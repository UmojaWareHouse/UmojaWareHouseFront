 ...
 * @author Brain
 */
public class ClsClient_Fidele  implements IActionManager{
    private int id;
    private String nom_complet, numero_tel, email;

    public ClsClient_Fidele() {
    }

    public ClsClient_Fidele(int id, String nom_complet, String numero_tel, String email) {
        this.id = id;
