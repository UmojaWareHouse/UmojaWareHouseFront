 ...
 * @author Brain
 */
public class ClsAgence  implements IActionManager{
    private int id;
    private String nom_agence, numero_tel, email;

    public ClsAgence() {
    }

    public ClsAgence(int id, String nom_agence, String numero_tel, String email) {
        this.id = id;
