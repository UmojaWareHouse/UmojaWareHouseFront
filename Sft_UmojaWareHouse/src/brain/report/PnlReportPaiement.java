 ...
 * @author Brain
 */
public class PnlReportPaiement extends javax.swing.JPanel {

    /**
     * Creates new form PnlReportEntry
     */
    public PnlReportPaiement() {
        initComponents();
        try
        {
    ...
    private void initComponents() {
        ...
        tabPaiement = new javax.swing.JTable();
        ...
        tabPaiement.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        tabPaiement.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        jScrollPane1.setViewportView(tabPaiement);
    ...
    private void cmbMoisPopupMenuWillBecomeInvisible(javax.swing.event.PopupMenuEvent evt) {//GEN-FIRST:event_cmbMoisPopupMenuWillBecomeInvisible
        try
        {
            ClsHelper.Load_TblData(tabPaiement, "SELECT p.id NUMERO_PAIEMENT, f.id FACTURE, p.libelle LIBELLE, "
    ...
    private void jLabel2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel2MouseClicked
        ...
        try 
        {
            ...
            ClsLoad_Report.Print_Report("src\\brain\\report\\rep_facturation.jrxml", 
                "SELECT p.id NUMERO_PAIEMENT, f.id FACTURE, p.libelle LIBELLE,  p.montant MONTANT, "
                    + "p.date_paiement DATE_PAIEMENT, u.uName [USER] FROM tPaiement p "
                    + "INNER JOIN tFacturation f ON p.idFacture = f.id "
                    + "INNER JOIN tUser u ON p.idUser = u.id "
                    + "INNER JOIN tMois m ON p.idMois = m.id "
                    + "INNER JOIN tAnnee a ON p.idAnnee = a.id "
    ...
    private javax.swing.JTable tabPaiement;
